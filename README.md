...
En el bloque de programación se trabaja con Python desde la primera sesión, en Jupyter Notebook a través de Google Colab, y con Thonny como segundo entorno local para la depuración paso a paso.
